...
$execute on passengers on passengers run data modify entity @s block_state set from storage np:plants plants.$(plantid).block_s1
$execute on passengers on passengers on passengers run data modify entity @s block_state set from storage np:plants plants.$(plantid).block_s1_2
