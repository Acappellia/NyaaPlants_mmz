...
execute if data storage np:tmp mainhand.components."minecraft:custom_data".np_fert run function np:interact/fert
execute if data storage np:tmp mainhand.components."minecraft:custom_data".np_fert run return 3
